function Pop() {
    var cssRuleFile = "C:/xampp/htdocs/test/cookieconsent.css";
    ...
    let content = {
        message: "Ta strona używa ciasteczek aby świadczyć usługi na najwyższym poziomie.",
        btnText: "Rozumiem",
        mode: "  banner bottom",
        theme: " theme-classic",
        palette: " box",
        link: "Czytaj więcej...",
        href: "http://www.czatmodelki.pl/images/Polityka prywatności-INTERCAM.pdf",
        target: "_blank",
    };
